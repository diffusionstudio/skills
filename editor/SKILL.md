...
**On failure, separate what you saw from what you suspect.** Report the observed error apart from suspected causes, and don't rerun an unchanged command unless the retry tests a named hypothesis. If you fall back to a weaker method, say what stays unverified.
