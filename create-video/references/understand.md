...
| `asset grab` | Fast | Free | Peek at individual frames; pin down scene transitions and exact cut timestamps |
...
- `asset grab` decodes the **asset's own pixels** at full resolution at source
